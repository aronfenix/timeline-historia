...
window.TIMELINE_DATA = (() => {
  ...
  const EDAD_MODERNA = {
    ...
    events: [
      ...
      { id:'M11', year:1512, title:'Conquista de Navarra', description:'Navarra se incorpora a la monarquia hispanica.', hint:'Primeros anos del XVI', category:'militar', funFact:'Navarra fue el ultimo reino peninsular en unirse a la corona espanola y conservo sus propias leyes durante siglos.', quizQuestion: { question:'Que reino peninsular fue el ultimo en incorporarse a la monarquia hispanica?', options:['Granada','Portugal','Navarra','Aragon'], correct:2 } },
      ...
      { id:'M17', year:1520, title:'Comienza la revuelta comunera', description:'Castilla se levanta contra decisiones del rey.', hint:'Mismo ano que Carlos V', category:'sociedad', funFact:'Los comuneros pedian que el rey respetase las leyes castellanas y no diera cargos importantes a extranjeros.', quizQuestion: { question:'Contra quien se rebelaron los comuneros de Castilla?', options:['Contra los musulmanes','Contra las decisiones de Carlos I','Contra la Iglesia','Contra Portugal'], correct:1 } },
      { id:'M18', year:1521, title:'Batalla de Villalar', description:'Derrota decisiva de los comuneros.', hint:'Ano siguiente a 1520', category:'militar', funFact:'Los lideres comuneros Padilla, Bravo y Maldonado fueron ejecutados al dia siguiente de perder la batalla.', quizQuestion: { question:'Que ocurrio en la batalla de Villalar?', options:['Victoria de los comuneros','Derrota definitiva de los comuneros','Victoria contra Francia','Derrota de los moriscos'], correct:1 } },
      ...
      { id:'M27', year:1580, title:'Felipe II rey de Portugal', description:'Se unen las coronas ibericas bajo un mismo rey.', hint:'Antes de 1588', category:'politica', funFact:'Con Portugal, Felipe II controlaba territorios en todos los continentes conocidos, el mayor imperio de la epoca.', quizQuestion: { question:'En que ano Felipe II se convirtio tambien en rey de Portugal?', options:['1556','1571','1580','1588'], correct:2 } },
      ...
      { id:'M32', year:1618, title:'Empieza la Guerra de los Treinta Anos', description:'Gran conflicto europeo de religion y poder.', hint:'Primera mitad del XVII', category:'militar', funFact:'La guerra comenzo cuando unos nobles protestantes tiraron a dos enviados del emperador por una ventana en Praga.', quizQuestion: { question:'Cuantos anos duro la Guerra de los Treinta Anos?', options:['20 anos','25 anos','30 anos','35 anos'], correct:2 } },
      ...
      { id:'M35', year:1643, title:'Derrota de Rocroi', description:'Golpe simbolico al prestigio militar hispanico.', hint:'Tres anos despues de 1640', category:'militar', funFact:'Los tercios espanoles eran considerados invencibles desde hacia mas de un siglo hasta que cayeron en Rocroi.', quizQuestion: { question:'Que unidad militar espanola fue derrotada simbolicamente en Rocroi?', options:['La Armada','Los tercios','La caballeria','La guardia real'], correct:1 } },
      { id:'M36', year:1648, title:'Paz de Westfalia', description:'Termina la Guerra de los Treinta Anos.', hint:'Mitad del XVII', category:'politica', funFact:'La Paz de Westfalia reconocio la independencia de los Paises Bajos tras 80 anos de lucha contra Espana.', quizQuestion: { question:'Que conflicto termino con la Paz de Westfalia de 1648?', options:['La Guerra de los Cien Anos','La Guerra de Sucesion','La Guerra de los Treinta Anos','Las guerras de Italia'], correct:2 } },
      ...
      { id:'M39', year:1668, title:'Portugal reconocido independiente', description:'Se confirma la separacion iniciada en 1640.', hint:'Muy cerca de 1665', category:'politica', funFact:'Portugal habia estado unido a la corona espanola durante 60 anos, desde 1580 hasta su rebelion en 1640.', quizQuestion: { question:'Cuantos anos estuvo Portugal unido a la corona espanola aproximadamente?', options:['20 anos','40 anos','60 anos','100 anos'], correct:2 } },
  ...
  const EDAD_CONTEMPORANEA = {
    ...
    events: [
      ...
      { id:'C05', year:1823, title:'Fin del Trienio Liberal', description:'Regresa el absolutismo con apoyo frances.', hint:'Tres anos despues de 1820', category:'politica', funFact:'Francia envio un ejercito de 100.000 hombres llamado "los Cien Mil Hijos de San Luis" para restaurar a Fernando VII.', quizQuestion: { question:'Que ejercito extranjero ayudo a Fernando VII a acabar con el Trienio Liberal?', options:['Los Cien Mil Hijos de San Luis','La Gran Armada inglesa','El ejercito prusiano','Las tropas austriacas'], correct:0 } },
      ...
      { id:'C29', year:1939, title:'Fin de la Guerra Civil', description:'Comienza la dictadura franquista.', hint:'Tres anos tras 1936', category:'militar', funFact:'Franco emitio su ultimo parte de guerra el 1 de abril de 1939 con la famosa frase: "La guerra ha terminado".', quizQuestion: { question:'Cuantos anos duro la Guerra Civil espanola?', options:['Dos anos','Tres anos','Cuatro anos','Cinco anos'], correct:1 } },
      ...
      { id:'C34', year:1975, title:'Muerte de Franco', description:'Fin de la dictadura.', hint:'Ultimo cuarto del XX', category:'politica', funFact:'La dictadura de Franco duro casi 40 anos, una de las mas largas de la Europa del siglo XX.', quizQuestion: { question:'Cuantos anos duro aproximadamente la dictadura de Franco?', options:['20 anos','30 anos','40 anos','50 anos'], correct:2 } },
      { id:'C35', year:1977, title:'Primeras elecciones democraticas', description:'Primeras desde la Segunda Republica.', hint:'En plena Transicion', category:'politica', funFact:'Millones de espanoles votaron por primera vez en su vida, ya que llevaban mas de 40 anos sin elecciones libres.', quizQuestion: { question:'Quien gano las primeras elecciones democraticas de 1977?', options:['El PSOE','Alianza Popular','UCD de Adolfo Suarez','El Partido Comunista'], correct:2 } },
      { id:'C36', year:1978, title:'Constitucion de 1978', description:'Base de la democracia actual.', hint:'Un ano despues de 1977', category:'politica', funFact:'La Constitucion fue aprobada en referendum el 6 de diciembre, por eso ese dia es festivo en toda Espana.', quizQuestion: { question:'Que dia se celebra en Espana la fiesta de la Constitucion?', options:['12 de octubre','6 de diciembre','1 de mayo','15 de agosto'], correct:1 } },
      ...
      { id:'C42', year:2002, title:'Euro en billetes y monedas', description:'Entrada del euro en la vida diaria.', hint:'Inicio del siglo XXI', category:'economia', funFact:'Durante dos meses las tiendas aceptaban tanto pesetas como euros para facilitar la transicion a la nueva moneda.', quizQuestion: { question:'En que ano empezaron a circular los billetes y monedas de euro?', options:['1999','2000','2001','2002'], correct:3 } },
      { id:'C43', year:2004, title:'Atentados del 11-M', description:'Mayor atentado terrorista en la historia de Espana.', hint:'Dos anos despues del euro', category:'sociedad', funFact:'Casi 200 personas murieron y mas de 1.500 resultaron heridas en los trenes de cercanias de Madrid.', quizQuestion: { question:'En que medio de transporte ocurrieron los atentados del 11-M?', options:['Autobuses','Aviones','Trenes de cercanias','Metro'], correct:2 } },
      ...
      { id:'C47', year:2018, title:'Disolucion de ETA', description:'Fin definitivo de la organizacion terrorista.', hint:'Final de la decada de 2010', category:'sociedad', funFact:'ETA habia actuado durante mas de 50 anos causando 853 victimas mortales antes de su disolucion definitiva.', quizQuestion: { question:'Cuantos anos aproximadamente estuvo activa la organizacion terrorista ETA?', options:['20 anos','30 anos','40 anos','Mas de 50 anos'], correct:3 } },
      { id:'C48', year:2020, title:'Pandemia de COVID-19', description:'Emergencia sanitaria global con gran impacto social.', hint:'Ano reciente', category:'sociedad', funFact:'Durante el confinamiento, los espanoles salian a aplaudir a los sanitarios desde sus balcones cada dia a las 20:00.', quizQuestion: { question:'Que medida excepcional se tomo en Espana durante la pandemia de 2020?', options:['Se cerraron las fronteras con Francia','Se decreto un estado de alarma y confinamiento','Se cancelaron las elecciones','Se prohibio internet'], correct:1 } }
    ]
  };
